...
<style>
  ...
  .stack-item:nth-child(2) .card_detail{
    background:#f5f6f7;
    box-shadow: 0px 6px 33px 2px rgba(50, 60, 95, 0.21);
  }
  .stack-item:nth-child(3) .card_detail{
    background:#f1f1f3;
    box-shadow: 0px 6px 33px 2px rgba(50, 60, 95, 0.23);
  }
  .stack-item .card_detail p{
      font-size: .44rem;
  }
  .stack-item .card_detail img{
    width: 5.7rem;
    height: 5.7rem;
    border-radius: .1rem;
    background: #eee;
